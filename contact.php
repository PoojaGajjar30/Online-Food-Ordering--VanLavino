...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/Map.jpg);height: 400px; background-size:cover;" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                    ...
                    <div class="contact-box p-4">
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3" style="background-color: #466995;"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="position:relative">
                          <div class="detail-box p-4" style="position:absolute; top:100px;">
                            <h5 class="text-black-50 font-weight-light mb-3">ADDRESS</h5>
                            <p class="text-black-50 op-7">' .$address. '</p>
                            <h5 class="text-black-50 font-weight-light mb-3 mt-4">CALL US</h5>
                            <p class="text-black-50 op-7">' .$contact1. '
                              <br> ' .$contact2. '</p>
                          </div>
                        </div>';
                  ?>
