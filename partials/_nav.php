...
echo '<nav class="navbar navbar-expand-lg">
      <a class="navbar-brand" href="index.php">Van Lavino</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form method="get" action="/vanlavino/search.php" class="form-inline my-2 my-lg-0 mx-3">
          <input class="form-control mr-sm-2" type="search" name="search" id="search" placeholder="Search" aria-label="Search" required>
          <button class="btn my-2 my-sm-0" type="submit" style="background-color: #953F46 ; color:white">Search</button>
        </form>';
        ...
        echo '<a href="viewCart.php"><button type="button" class="btn mx-2" style="background-color: #953F46 ; color:white" title="MyCart">
        ...
        if($loggedin){
          ...
          echo '
          <button type="button" class="btn  mx-2" style="background-color: #953F46; color:white" data-toggle="modal" data-target="#loginModal">Login</button>
          <button type="button" class="btn  mx-2" style="background-color: #953F46 ; color:white" data-toggle="modal" data-target="#signupModal">SignUp</button>
';
        }
